...
MetronicApp.factory('dataService', ['$http', 'ApiUrl', '$q', 'storageService', '$rootScope', function ($http, ApiUrl, $q, storageService, $rootScope) {
    ...
    function getCasesSoldReportData(reportFilters) {
        var promise = $q.defer();
        var request = $http.post(baseUrl + "CasesSoldSales/GetCasesSoldReport",
            reportFilters,
            {
                timeout: promise.promise
            })
    ...
    return {
     ...
     //   GetForcastReport: getForcastReport,
        ...
        getCasesSoldReportData: getCasesSoldReportData,
