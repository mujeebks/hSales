...
MetronicApp.controller('transportationController', ['$scope', 'dataService', '$stateParams', '$filter', 'NotificationService', '$controller','$rootScope',
    function ($scope, dataService, $stateParams, $filter, NotificationService, $controller, $rootScope) {
